...
public class BinaryTree {
    ...
    public int treeDiameter(TreeNode root) {
        int[] max = new int[1];
        treeDiameterHelper(root, max);
        return max[0];
    }
    public int treeDiameterHelper(TreeNode root, int[] max) {
        if (root == null) {
            return 0;
        }
        int left = treeDiameterHelper(root.left, max);
        int right = treeDiameterHelper(root.right, max);
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println();
        System.out.print("The diameter is : " + binaryTree.treeDiameter(root));
    }
}
